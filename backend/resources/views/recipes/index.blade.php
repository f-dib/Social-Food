...
<div class="container max-w-full max-h-full bg-gray-600 p-7 rounded-ss-3xl">
    ...
    <div class="flex flex-wrap justify-center gap-4 pt-7">
        ...
        <div href="{{ route('admin.recipes.create') }}" class="block w-full p-6 bg-white border border-gray-200 shadow rounded-3xl hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
